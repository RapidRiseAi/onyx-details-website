...
export function InfoPopover({ label, description }: InfoPopoverProps) {
  return (
    <details className="group relative inline-block">
      ...
      <div className="absolute left-0 top-7 z-20 w-64 rounded-md border border-zinc-700 bg-zinc-950 p-2 text-xs leading-relaxed text-zinc-200 shadow-xl md:w-72">
        {description}
      </div>
    </details>
  );
